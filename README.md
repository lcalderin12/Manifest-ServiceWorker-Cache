...
# Manifest CaSH while Servicing your Work
...
## Description 
This PWA tracks transactions made online and offline. You start by naming your transaction and the amount. The transaction may be either added or subtracted from the total funds. The reflection of the transactions us reflected on the graph ate the bottom of the page. The primary code of this app is for the purposes of converting this working budget app into a PWA. The manifest folder, along with the service worker and the cache, is responsible for creating the progressive web app. The indexDB is responsible for linking the offline data transaction with the mongo database once brought on back online.
...
## Usage
Use this app to budget your income and cost in offline mode as well as online.
## Screenshots
![](img/info.png)
